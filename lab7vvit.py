...
dates_first_week = ['2023-02-27', '2023-02-28', '2023-03-01', '2023-03-02', '2023-03-03', '2023-03-04', '2023-03-05',
                    '2023-03-13', '2023-03-14',
                    '2023-03-15', '2023-03-16', '2023-03-17', '2023-03-18', '2023-03-19', '2023-03-27', '2023-03-28',
                    '2023-03-29', '2023-03-30',
                    '2023-03-31', '2023-04-01', '2023-04-02', '2023-04-10', '2023-04-11', '2023-04-12', '2023-04-13',
                    '2023-04-14', '2023-04-15',
                    '2023-04-16', '2023-04-24', '2023-04-25', '2023-04-26', '2023-04-27', '2023-04-28', '2023-04-29',
                    '2023-04-30', '2023-05-08',
                    '2023-05-09', '2023-05-10', '2023-05-11', '2023-05-12', '2023-05-13', '2023-05-14', '2023-05-22',
                    '2023-05-23', '2023-05-24',
                    '2023-05-25', '2023-05-26', '2023-05-27', '2023-05-28', '2023-06-05', '2023-06-06', '2023-06-07',
                    '2023-06-08', '2023-06-09',
                    '2023-06-10', '2023-06-11', '2023-06-19', '2023-06-20', '2023-06-21', '2023-06-22', '2023-06-23',
                    '2023-06-24', '2023-06-25']

conn = psycopg2.connect(dbname='schedule', user='postgres', password="zalyalievakazakova", host="localhost",
                        port="5432")

cursor = conn.cursor()
cursor.execute("SELECT firsttt_week.day, firsttt_week.timee, subjectss.name, teacherr.name,"
               " firsttt_week.room FROM firsttt_week JOIN subjectss ON firsttt_week.subjectss = subjectss.name JOIN teacherr ON subjectss.name = teacherr.subjectss;")
f = (list(cursor.fetchall()))
cursor.execute('SELECT secondddd_week.day, secondddd_week.timee, subjectss.name, teacherr.name,'
               ' secondddd_week.room FROM secondddd_week JOIN subjectss ON secondddd_week.subjectss = subjectss.name JOIN teacherr ON subjectss.name = teacherr.subjectss;')
s = (list(cursor.fetchall()))

token = '6043215481:AAHwPQw3AXWL5Qzxdao2P42CT271on-awIY'
...
def day(call):
    if call.data == 'first':
        ...
        bot.send_message(call.message.chat.id, 'На какой день недели хотите получить расписание?',
